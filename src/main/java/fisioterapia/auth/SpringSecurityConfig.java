...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .requestMatchers(HttpMethod.GET, "/api/citas", "/api/citas/{id}").authenticated()
        ...
        .requestMatchers(HttpMethod.GET, "/api/agenda", "/api/agenda/{id}").hasRole("FISIOTERAPEUTA")
        .requestMatchers(HttpMethod.POST, "/api/agenda").hasRole("FISIOTERAPEUTA")
        .requestMatchers(HttpMethod.PUT, "/api/agenda/{id}").hasRole("FISIOTERAPEUTA")
        .requestMatchers(HttpMethod.DELETE, "/api/agenda/{id}").hasRole("FISIOTERAPEUTA")
